...
local MINOR_VERSION = tonumber(string.sub("$Revision: 17000 $", 14, -3))
...
BabbleSpell:RegisterTranslations("ruRU", function()
	return {
		...
		["Portal: Stonard"] = "Портал в Стонард",
		["Portal: Theramore"] = "Портал в Терамор",
		...
		["Teleport: Stonard"] = "Телепортация: Стонард",
		["Teleport: Theramore"] = "Телепортация: Терамор",
...
BabbleSpell:RegisterTranslations("deDE", function()
	return {
		...
		["Teleport: Stonard"]= "Teleportieren: Stonard",
		["Teleport: Theramore"] = "Teleportieren: Theramore",
...
BabbleSpell:RegisterTranslations("frFR", function()
	return {
		...
		["Teleport: Stonard"] = "T\195\169l\195\169portation : Stonard", --  Need to translated
		["Teleport: Theramore"] = "T\195\169l\195\169portation : Theramore", --  Need to translated
		["The Beast Within"] = "The Beast Within",  --  Need to translated
